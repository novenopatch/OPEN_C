...
public class ZFenetre extends JFrame {
    ...
    private JMenuItem item4 = new  JMenuItem("Lancer");
    private JMenuItem item3 = new  JMenuItem("Arrêter");
    private JCheckBoxMenuItem jcmi1 = new JCheckBoxMenuItem("Choix1");
    private JCheckBoxMenuItem jcmi2 = new JCheckBoxMenuItem("Choix2");
